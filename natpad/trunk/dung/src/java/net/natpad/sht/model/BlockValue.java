...
public class BlockValue extends Value implements MapValue {

	TemplateCall templateCall;
	protected ArrayList<Reference> list = new ArrayList<Reference>();
	...
	public void remove(Reference refidref) {
		list.remove(refidref);
	}
