...
G_DEFINE_TYPE_WITH_CODE(JagPJCArrayTypeTree, jagp_jcarray_type_tree, JAGP_TYPE_JCEXPRESSION,
		G_IMPLEMENT_INTERFACE(CAT_TYPE_ISTRINGABLE, l_stringable_iface_init)
);

static void l_dispose(GObject *object);
static void l_finalize(GObject *object);
static JagPTag l_tree_get_tag(JagPJCTree *tree) { return JAGP_TAG_TYPEARRAY; }

static void jagp_jcarray_type_tree_class_init(JagPJCArrayTypeTreeClass *clazz) {
...
static void jagp_jcarray_type_tree_init(JagPJCArrayTypeTree *instance) {
}
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jagp_jcarray_type_tree_parent_class)->finalize(object);
...
static void l_stringable_print(CatIStringable *self, struct _CatStringWo *append_to) {
	JagPJCArrayTypeTree *instance = JAGP_JCARRAY_TYPE_TREE(self);
