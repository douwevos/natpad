...
static void jag_ast_try_catch_finally_statement_class_init(JagAstTryCatchFinallyStatementClass *clazz) {
	...
	g_type_class_add_private(clazz, sizeof(JagAstTryCatchFinallyStatementPrivate));
...
static void jag_ast_try_catch_finally_statement_init(JagAstTryCatchFinallyStatement *instance) {
	JagAstTryCatchFinallyStatementPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE(instance, JAG_AST_TYPE_TRY_CATCH_FINALLY_STATEMENT, JagAstTryCatchFinallyStatementPrivate);
	instance->priv = priv;
}
...
static void l_dispose(GObject *object) {
	...
	JagAstTryCatchFinallyStatementPrivate *priv = instance->priv;
...
JagAstTryCatchFinallyStatement *jag_ast_try_catch_finally_statement_new(JagAstBlock *try_block, CatArrayWo *e_catch_blocks, JagAstFinallyBlock *finally_block) {
	...
	JagAstTryCatchFinallyStatementPrivate *priv = result->priv;
...
static void l_statement_set_at_least_line_nr(JagAstIStatement *self, int at_least_line_nr) {
	JagAstTryCatchFinallyStatementPrivate *priv = JAG_AST_TRY_CATCH_FINALLY_STATEMENT_GET_PRIVATE(self);
