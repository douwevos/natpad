...
static void jag_ast_instance_of_expression_class_init(JagAstInstanceOfExpressionClass *clazz) {
	...
	g_type_class_add_private(clazz, sizeof(JagAstInstanceOfExpressionPrivate));
...
static void jag_ast_instance_of_expression_init(JagAstInstanceOfExpression *instance) {
	JagAstInstanceOfExpressionPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE(instance, JAG_AST_TYPE_INSTANCE_OF_EXPRESSION, JagAstInstanceOfExpressionPrivate);
	instance->priv = priv;
}
...
static void l_dispose(GObject *object) {
	...
	JagAstInstanceOfExpressionPrivate *priv = instance->priv;
...
JagAstInstanceOfExpression *jag_ast_instance_of_expression_new(JagAstDeclarationType *cast_type, JagAstIExpression *expression) {
	...
	JagAstInstanceOfExpressionPrivate *priv = result->priv;
...
static void l_expression_write(JagAstIExpression *self, JagAstWriter *out) {
	JagAstInstanceOfExpressionPrivate *priv = JAG_AST_INSTANCE_OF_EXPRESSION_GET_PRIVATE(self);
