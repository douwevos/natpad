...
static void jag_ast_expression_statement_class_init(JagAstExpressionStatementClass *clazz) {
	...
	g_type_class_add_private(clazz, sizeof(JagAstExpressionStatementPrivate));
...
static void jag_ast_expression_statement_init(JagAstExpressionStatement *instance) {
	JagAstExpressionStatementPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE(instance, JAG_AST_TYPE_EXPRESSION_STATEMENT, JagAstExpressionStatementPrivate);
	instance->priv = priv;
}
...
static void l_dispose(GObject *object) {
	...
	JagAstExpressionStatementPrivate *priv = instance->priv;
...
JagAstExpressionStatement *jag_ast_expression_statement_new(JagAstIExpression *expression) {
	...
	JagAstExpressionStatementPrivate *priv = result->priv;
...
static void l_statement_set_at_least_line_nr(JagAstIStatement *self, int at_least_line_nr) {
	JagAstExpressionStatementPrivate *priv = JAG_AST_EXPRESSION_STATEMENT_GET_PRIVATE(self);
