...
static void jag_ast_package_statement_class_init(JagAstPackageStatementClass *clazz) {
	...
	g_type_class_add_private(clazz, sizeof(JagAstPackageStatementPrivate));
...
static void jag_ast_package_statement_init(JagAstPackageStatement *instance) {
	JagAstPackageStatementPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE(instance, JAG_AST_TYPE_PACKAGE_STATEMENT, JagAstPackageStatementPrivate);
	instance->priv = priv;
}
...
static void l_dispose(GObject *object) {
	...
	JagAstPackageStatementPrivate *priv = instance->priv;
...
JagAstPackageStatement *jag_ast_package_statement_new(JagAstIdentifier *package_name) {
	...
	JagAstPackageStatementPrivate *priv = result->priv;
...
static void l_statement_set_at_least_line_nr(JagAstIStatement *self, int at_least_line_nr) {
	JagAstPackageStatementPrivate *priv = JAG_AST_PACKAGE_STATEMENT_GET_PRIVATE(self);
