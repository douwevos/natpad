...
#define MOO_MODULE_REFRESH_VIPER_REQUEST_GET_PRIVATE(obj)  (G_TYPE_INSTANCE_GET_PRIVATE ((obj), MOO_TYPE_MODULE_REFRESH_VIPER_REQUEST, MooModuleRefreshViperRequestPrivate))
...
struct _MooModuleRefreshViperRequest {
	WorRequest parent;
	MooModuleRefreshViperRequestPrivate *priv;
};
