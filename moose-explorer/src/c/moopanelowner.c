...
static void l_dispose(GObject *object) {
	...
	MooPanelOwnerPrivate *priv = moo_panel_owner_get_instance_private(instance);
	...
	G_OBJECT_CLASS(moo_panel_owner_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(moo_panel_owner_parent_class)->finalize(object);
...
MooPanelOwner *moo_panel_owner_new(MooService *moo_service, LeaFrame *frame) {
	...
	MooPanelOwnerPrivate *priv = moo_panel_owner_get_instance_private(result);
...
MooNodeRenderRegistry *moo_panel_owner_get_render_registry(MooPanelOwner *panel_owner) {
	MooPanelOwnerPrivate *priv = moo_panel_owner_get_instance_private(panel_owner);
...
static LeaKeyContext *l_panel_owner_get_key_context(LeaIPanelOwner *self) {
	MooPanelOwner *instance = MOO_PANEL_OWNER(self);
	MooPanelOwnerPrivate *priv = moo_panel_owner_get_instance_private(instance);
