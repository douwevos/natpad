/* This file was generated by Gross-CC on 2017.03.29 AD at 21:41:25 CEST */
...
GObject *l_iaction_handler_run_action(GroRunIActionHandler *self, GroRunFork *fork, GroRunReduceLayout *reduce_layout, int action_id) {
	...
	switch(prod_id) {
		...
		case 1 : { // ImportDeclarationMultiOpt TypeDeclarationMultiOpt⇒CompilationUnit
			result = (GObject *) jagp_compilation_unit_new_1();
		} break;

		case 2 : { // PackageDeclaration ImportDeclarationMultiOpt TypeDeclarationMultiOpt⇒CompilationUnit
			result = (GObject *) jagp_compilation_unit_new_1();
		} break;
	}
	return result;
