...
static void jag_ast_array_length_expression_class_init(JagAstArrayLengthExpressionClass *clazz) {
	...
	g_type_class_add_private(clazz, sizeof(JagAstArrayLengthExpressionPrivate));
...
static void jag_ast_array_length_expression_init(JagAstArrayLengthExpression *instance) {
	JagAstArrayLengthExpressionPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE(instance, JAG_AST_TYPE_ARRAY_LENGTH_EXPRESSION, JagAstArrayLengthExpressionPrivate);
	instance->priv = priv;
}
...
static void l_dispose(GObject *object) {
	...
	JagAstArrayLengthExpressionPrivate *priv = instance->priv;
...
JagAstArrayLengthExpression *jag_ast_array_length_expression_new(JagAstIExpression *main_expression) {
	...
	JagAstArrayLengthExpressionPrivate *priv = result->priv;
...
static void l_expression_write(JagAstIExpression *self, JagAstWriter *out) {
	JagAstArrayLengthExpressionPrivate *priv = JAG_AST_ARRAY_LENGTH_EXPRESSION_GET_PRIVATE(self);
