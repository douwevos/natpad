...
G_DEFINE_TYPE_WITH_CODE(JagAstArrayAccessExpression, jag_ast_array_access_expression, G_TYPE_OBJECT, {
		G_ADD_PRIVATE(JagAstArrayAccessExpression)
...
static void l_dispose(GObject *object) {
	...
	JagAstArrayAccessExpressionPrivate *priv = jag_ast_array_access_expression_get_instance_private(instance);
	cat_unref_ptr(priv->main_expression);
	cat_unref_ptr(priv->dim_expression);
	G_OBJECT_CLASS(jag_ast_array_access_expression_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_ast_array_access_expression_parent_class)->finalize(object);
...
JagAstArrayAccessExpression *jag_ast_array_access_expression_new(JagAstIExpression *main_expression, JagAstIExpression *dim_expression) {
	...
	JagAstArrayAccessExpressionPrivate *priv = jag_ast_array_access_expression_get_instance_private(result);
...
static void l_expression_write(JagAstIExpression *self, JagAstWriter *out) {
	JagAstArrayAccessExpression *expr= JAG_AST_ARRAY_ACCESS_EXPRESSION(self);
	JagAstArrayAccessExpressionPrivate *priv = jag_ast_array_access_expression_get_instance_private(expr);
...
static gboolean l_expression_equal(JagAstIExpression *self, JagAstIExpression *other) {
	...
	if (JAG_AST_IS_ARRAY_ACCESS_EXPRESSION(other)) {
		JagAstArrayAccessExpressionPrivate *priv = jag_ast_array_access_expression_get_instance_private(JAG_AST_ARRAY_ACCESS_EXPRESSION(self));
		JagAstArrayAccessExpressionPrivate *o_priv = jag_ast_array_access_expression_get_instance_private(JAG_AST_ARRAY_ACCESS_EXPRESSION(other));
