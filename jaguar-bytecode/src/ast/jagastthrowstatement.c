...
G_DEFINE_TYPE_WITH_CODE(JagAstThrowStatement, jag_ast_throw_statement, G_TYPE_OBJECT, {
		G_ADD_PRIVATE(JagAstThrowStatement)
...
static void l_dispose(GObject *object) {
	...
	JagAstThrowStatementPrivate *priv = jag_ast_throw_statement_get_instance_private(instance);
	cat_unref_ptr(priv->throw_expression);
	G_OBJECT_CLASS(jag_ast_throw_statement_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_ast_throw_statement_parent_class)->finalize(object);
...
JagAstThrowStatement *jag_ast_throw_statement_new(JagAstIExpression *throw_expression) {
	...
	JagAstThrowStatementPrivate *priv = jag_ast_throw_statement_get_instance_private(result);
...
static void l_statement_set_at_least_line_nr(JagAstIStatement *self, int at_least_line_nr) {
	JagAstThrowStatement *instance = JAG_AST_THROW_STATEMENT(self);
	JagAstThrowStatementPrivate *priv = jag_ast_throw_statement_get_instance_private(instance);
