...
G_DEFINE_TYPE_WITH_CODE(JagAstFinallyBlock, jag_ast_finally_block, JAG_AST_TYPE_BLOCK, { // @suppress("Unused static function")
...
static void l_dispose(GObject *object) {
	...
	G_OBJECT_CLASS(jag_ast_finally_block_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_ast_finally_block_parent_class)->finalize(object);
