...
static void jag_ast_new_expression_class_init(JagAstNewExpressionClass *clazz) {
	...
	g_type_class_add_private(clazz, sizeof(JagAstNewExpressionPrivate));
...
static void jag_ast_new_expression_init(JagAstNewExpression *instance) {
	JagAstNewExpressionPrivate *priv = G_TYPE_INSTANCE_GET_PRIVATE(instance, JAG_AST_TYPE_NEW_EXPRESSION, JagAstNewExpressionPrivate);
	instance->priv = priv;
}
...
static void l_dispose(GObject *object) {
	...
	JagAstNewExpressionPrivate *priv = instance->priv;
...
JagAstNewExpression *jag_ast_new_expression_new(JagAstIdentifier *identifier, CatArrayWo *e_dim_expressions) {
	...
	JagAstNewExpressionPrivate *priv = result->priv;
...
static void l_expression_write(JagAstIExpression *self, JagAstWriter *out) {
	JagAstNewExpressionPrivate *priv = JAG_AST_NEW_EXPRESSION_GET_PRIVATE(self);
