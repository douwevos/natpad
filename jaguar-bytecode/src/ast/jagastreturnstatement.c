...
G_DEFINE_TYPE_WITH_CODE(JagAstReturnStatement, jag_ast_return_statement, G_TYPE_OBJECT, {
		G_ADD_PRIVATE(JagAstReturnStatement)
...
static void l_dispose(GObject *object) {
	...
	JagAstReturnStatementPrivate *priv = jag_ast_return_statement_get_instance_private(instance);
	cat_unref_ptr(priv->return_expression);
	G_OBJECT_CLASS(jag_ast_return_statement_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_ast_return_statement_parent_class)->finalize(object);
...
JagAstReturnStatement *jag_ast_return_statement_new(JagAstIExpression *return_expression) {
	...
	JagAstReturnStatementPrivate *priv = jag_ast_return_statement_get_instance_private(result);
...
JagAstIExpression *jag_ast_return_statement_get_expression(JagAstReturnStatement *return_statement) {
	JagAstReturnStatementPrivate *priv = jag_ast_return_statement_get_instance_private(return_statement);
...
static void l_statement_set_at_least_line_nr(JagAstIStatement *self, int at_least_line_nr) {
	JagAstReturnStatement *instance = JAG_AST_RETURN_STATEMENT(self);
	JagAstReturnStatementPrivate *priv = jag_ast_return_statement_get_instance_private(instance);
