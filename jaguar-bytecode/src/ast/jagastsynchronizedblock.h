/*
   File:    jagastsynchronizedblock.h
...
#define JAG_AST_TYPE_SYNCHRONIZED_BLOCK              (jag_ast_synchronized_block_get_type())
#define JAG_AST_SYNCHRONIZED_BLOCK(obj)              (G_TYPE_CHECK_INSTANCE_CAST ((obj), jag_ast_synchronized_block_get_type(), JagAstSynchronizedBlock))
#define JAG_AST_SYNCHRONIZED_BLOCK_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST ((klass), JAG_AST_TYPE_SYNCHRONIZED_BLOCK, JagAstSynchronizedBlockClass))
...
typedef struct _JagAstSynchronizedBlockClass          JagAstSynchronizedBlockClass;
...
GType jag_ast_synchronized_block_get_type();
