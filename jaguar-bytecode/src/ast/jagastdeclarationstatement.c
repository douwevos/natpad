...
G_DEFINE_TYPE_WITH_CODE(JagAstDeclarationStatement, jag_ast_declaration_statement, G_TYPE_OBJECT, {
		G_ADD_PRIVATE(JagAstDeclarationStatement)
...
static void l_dispose(GObject *object) {
	...
	JagAstDeclarationStatementPrivate *priv = jag_ast_declaration_statement_get_instance_private(instance);
	cat_unref_ptr(priv->declaration_type);
	cat_unref_ptr(priv->assignment);
	G_OBJECT_CLASS(jag_ast_declaration_statement_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_ast_declaration_statement_parent_class)->finalize(object);
...
JagAstDeclarationStatement *jag_ast_declaration_statement_new(JagAstDeclarationType *declaration_type, JagAstAssignment *assignment) {
	...
	JagAstDeclarationStatementPrivate *priv = jag_ast_declaration_statement_get_instance_private(result);
...
static void l_statement_set_at_least_line_nr(JagAstIStatement *self, int at_least_line_nr) {
	JagAstDeclarationStatement *instance = JAG_AST_DECLARATION_STATEMENT(self);
	JagAstDeclarationStatementPrivate *priv = jag_ast_declaration_statement_get_instance_private(instance);
