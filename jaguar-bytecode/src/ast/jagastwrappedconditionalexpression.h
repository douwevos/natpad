/*
   File:    jagastwrappedconditionalexpression.h
...
#define JAG_AST_TYPE_WRAPPED_CONDITIONAL_EXPRESSION              (jag_ast_wrapped_conditional_expression_get_type())
#define JAG_AST_WRAPPED_CONDITIONAL_EXPRESSION(obj)              (G_TYPE_CHECK_INSTANCE_CAST ((obj), jag_ast_wrapped_conditional_expression_get_type(), JagAstWrappedConditionalExpression))
#define JAG_AST_WRAPPED_CONDITIONAL_EXPRESSION_CLASS(klass)      (G_TYPE_CHECK_CLASS_CAST ((klass), JAG_AST_TYPE_WRAPPED_CONDITIONAL_EXPRESSION, JagAstWrappedConditionalExpressionClass))
...
typedef struct _JagAstWrappedConditionalExpressionClass          JagAstWrappedConditionalExpressionClass;
...
GType jag_ast_wrapped_conditional_expression_get_type();
