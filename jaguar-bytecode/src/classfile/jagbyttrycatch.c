...
G_DEFINE_TYPE_WITH_PRIVATE(JagBytTryCatch, jag_byt_try_catch, G_TYPE_OBJECT)
...
static void l_dispose(GObject *object) {
	...
	JagBytTryCatchPrivate *priv = jag_byt_try_catch_get_instance_private(instance);
	cat_unref_ptr(priv->e_catch_list);
	G_OBJECT_CLASS(jag_byt_try_catch_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_byt_try_catch_parent_class)->finalize(object);
...
JagBytTryCatch *jag_byt_try_catch_new(int start_pc, int end_pc, CatArrayWo *e_catch_list) {
	...
	JagBytTryCatchPrivate *priv = jag_byt_try_catch_get_instance_private(result);
...
int jag_byt_try_catch_get_start_pc(JagBytTryCatch *try_catch) {
	JagBytTryCatchPrivate *priv = jag_byt_try_catch_get_instance_private(try_catch);
