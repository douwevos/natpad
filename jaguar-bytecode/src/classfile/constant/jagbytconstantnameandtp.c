...
G_DEFINE_TYPE_WITH_CODE(JagBytConstantNameAndTp, jag_byt_constant_name_and_tp, G_TYPE_OBJECT, {
		G_ADD_PRIVATE(JagBytConstantNameAndTp)
...
static void l_dispose(GObject *object) {
	...
	JagBytConstantNameAndTpPrivate *priv = jag_byt_constant_name_and_tp_get_instance_private(instance);
	cat_unref_ptr(priv->a_name);
	cat_unref_ptr(priv->a_descriptor);
	G_OBJECT_CLASS(jag_byt_constant_name_and_tp_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_byt_constant_name_and_tp_parent_class)->finalize(object);
...
JagBytConstantNameAndTp *jag_byt_constant_name_and_tp_new(int name_index, int descriptor_index) {
	...
	JagBytConstantNameAndTpPrivate *priv = jag_byt_constant_name_and_tp_get_instance_private(result);
...
CatStringWo *jag_byt_constant_name_and_tp_get_name(JagBytConstantNameAndTp *name_and_type) {
	JagBytConstantNameAndTpPrivate *priv = jag_byt_constant_name_and_tp_get_instance_private(name_and_type);
	return priv->a_name;
}
...
static gboolean l_constant_is_resolved(JagBytIConstant *self) {
	JagBytConstantNameAndTp *instance = JAG_BYT_CONSTANT_NAME_AND_TP(self);
	JagBytConstantNameAndTpPrivate *priv = jag_byt_constant_name_and_tp_get_instance_private(instance);
