...
static void l_dispose(GObject *object) {
	...
	G_OBJECT_CLASS(jag_byt_finally_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_byt_finally_parent_class)->finalize(object);
...
JagBytFinally *jag_byt_finally_new(int handle_pc) {
	...
	JagBytFinallyPrivate *priv = jag_byt_finally_get_instance_private(result);
...
static int l_catch_or_finally_get_handle_pc(JagBytICatchOrFinally *self) {
	JagBytFinally *instance = JAG_BYT_FINALLY(self);
	JagBytFinallyPrivate *priv = jag_byt_finally_get_instance_private(instance);
