...
G_DEFINE_TYPE_WITH_PRIVATE(JagBytLocalVariableTable, jag_byt_local_variable_table, G_TYPE_OBJECT)
...
static void l_dispose(GObject *object) {
	...
	JagBytLocalVariableTablePrivate *priv = jag_byt_local_variable_table_get_instance_private(instance);
	cat_unref_ptr(priv->e_entries);
	G_OBJECT_CLASS(jag_byt_local_variable_table_parent_class)->dispose(object);
...
static void l_finalize(GObject *object) {
	...
	G_OBJECT_CLASS(jag_byt_local_variable_table_parent_class)->finalize(object);
...
JagBytLocalVariableTable *jag_byt_local_variable_table_new() {
	...
	JagBytLocalVariableTablePrivate *priv = jag_byt_local_variable_table_get_instance_private(result);
...
JagBytLocalVariableTableEntry *jag_byt_local_variable_table_find_entry(JagBytLocalVariableTable *local_variable_table, int frameIndex, int index) {
	JagBytLocalVariableTablePrivate *priv = jag_byt_local_variable_table_get_instance_private(local_variable_table);
